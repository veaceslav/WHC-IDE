...
void Ide::startNewProject(QString whcFiles)
{
    ...
    connect(model, SIGNAL(updateDiagram(QString, QString, QString)),
            diagram, SLOT(renameDiagItems(QString, QString, QString)));
    connect(model, SIGNAL(updateDiagram(QString, QString, QString)),
            diagram, SLOT(renameTaskMenu(QString, QString, QString)));
