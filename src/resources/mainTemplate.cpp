 ...
 *        argv[2]        - first input file-name;
 *        ......
 *        argv[argc - 4] - "-out". Specifies that the next argument
 *                         will be the output file-name. Each task
 *                         can only have one output file;
 *        argv[argc - 3] - output file-name;
 *        argv[argc - 2] - "-dev". Specifies that the next argument
 *                         will be the device index. The device index
 *                         selects the device that will run the task;
 *        argv[argv - 1] - device index (starting at 0).
 */
